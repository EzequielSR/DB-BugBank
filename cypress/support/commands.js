...
Cypress.Commands.add('cadastroComSaldo', () => {
...
Cypress.Commands.add('aparecerMensagemObrigatorio', () => {
    cy.visit('https://bugbank.netlify.app')
...
Cypress.Commands.add('transferencia', () => {
    cy.get('.styles__ContainerFormTransfer-sc-1oow0wh-0 > :nth-child(2) > .input__default').type('480')
    cy.get(':nth-child(3) > .input__default').type('Feliz Natal!')
